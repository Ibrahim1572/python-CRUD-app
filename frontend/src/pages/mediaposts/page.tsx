    ...
    return (
        <div className="flex flex-col gap-y-16 min-h-screen w-full bg-black font-sans">
            <div className="flex flex-row flex-wrap gap-3 p-6 bg-[#181818] items-center justify-center border-b border-[#202020]">
                <div onClick={()=>{setCurrentView('profile')}} className="bg-[#FFC000] text-black px-6 py-4 text-sm font-normal uppercase tracking-normal rounded-none cursor-pointer transition-colors duration-150 hover:bg-[#917300]">
                    Profile
                </div>
                ...
                <div onClick={()=>{setCurrentView('logout')}} className="bg-[#969696] text-[#202020] px-4 py-4 text-[13px] font-light uppercase tracking-[0.13px] rounded-none cursor-pointer transition-colors duration-150 hover:bg-[#7D7D7D]">
                    Logout
                </div>
            </div>
